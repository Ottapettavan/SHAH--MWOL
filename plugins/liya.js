...
const lol = "need some word\n🗡🗡enthelum ezhuthu nenba"
    ...
    Asena.addCommand({ pattern: 'afi ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'afi ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
